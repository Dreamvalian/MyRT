...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{ url('home-user') }}">MyRT</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Activity User</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="{{ url('home-user') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="{{url('activity-user')}}"></a>Activity User</li>
                    </ol>
                    <div class="card mb-4">
