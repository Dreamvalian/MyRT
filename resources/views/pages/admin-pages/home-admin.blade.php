...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
      <div class="input-group">
        <input class="form-control" id="tableSearch" type="text" placeholder="Search for..." aria-label="Search for..."
        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            ...
            <td>
              ...
              data-bs-target="#residentModal{{$rsd->nomor_kk}}">View Details
              </button>
            </td>
            </tr>
          @endforeach
  ...
  <!-- Modal -->
  @foreach ($residents as $rsd)
    <div class="modal fade" id="residentModal{{$rsd->nomor_kk}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
